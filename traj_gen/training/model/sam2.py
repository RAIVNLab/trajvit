...
class SAM2Train(SAM2Base):
    def __init__(
        ...
        rand_init_cond_frames_for_train=False,  # default: random 1~num_init_cond_frames_for_train cond frames (to be constent w/ previous TA data loader)
    ...
    def forward(self, input: BatchedVideoDatapoint, backbone_out: dict = None):
        # TODO
    ...
    def prepare_prompt_inputs(self, backbone_out, input, start_frame_idx=0):
        ...
        backbone_out["gt_masks_per_frame"] = gt_masks_per_frame # TODO: first important thing
        ...
        backbone_out["init_cond_frames"] = init_cond_frames # TODO: second important thing
